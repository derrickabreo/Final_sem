...
public class JobAct extends AppCompatActivity {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    String str=json_data.getString("vacancy");
